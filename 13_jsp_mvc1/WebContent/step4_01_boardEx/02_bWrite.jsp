...
<body>
	<div align="center" style="padding-top: 100px"> <!-- div 태그: 웹사이트의 레이아웃(전체적인 틀)을 만들 때 주로 사용  / CSS를 활용하여 스타일 적용-->
		<form action="03_bWritePro.jsp" name="f" method="post" onsubmit="return formValidationCheck()"> <!--  메서드 명앞에 return 키워드를 붙이며 return 값이 false이면 데이터를 서버로 전송하지 않음 -->
			<h2>게시글 쓰기</h2>
			<br>
			<table style="width: 700px;" border="1">
				...
				<tr>
					<td align="center"><span style="color: red">*</span> 작성자</td> <!--span 태그: div태그와 비슷  / line에 스타일 적용 -->
